...
@register_model
def kuramoto_inverted_double_pendulum(**kwargs) -> KuramotoForClassification:
    """InvertedDoublePendulum policy: 9 observations -> 64 oscillators -> 1 action mean, 10 Euler steps."""
    model_args = dict(n=64, in_dim=9, num_classes=1, T=1.0, num_steps=10, k_scale=1.0)
    return _create_kuramoto(**dict(model_args, **kwargs))
